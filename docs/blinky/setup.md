...
1. Switch into the `blinky` directory: `cd blinky` (DO NOT FORGET THIS! THE DEV CONTAINER WILL NOT WORK PROPERLY IF YOU SKIP THIS)
1. Open VS Code: `code .`
...
If you did everything properly, your code should be open in VS Code, the bottom left hand corner will note that you're in a Dev Container, and the open workspace will be for `blinky`. If that's all good, we can finally get to coding!
